...
class SensorSimulator:
    ...
    def generate_presence_data(self) -> dict:
        ...
        Occasionally toggle occupancy state.
        Also simulate an occasional sensor offline event.
        """
    ...
    def generate_iaq_data(self) -> dict:
        ...
        # Determine occupancy contribution
    ...
    def generate_power_data(self) -> dict:
        ...
        # HVAC factor: if CO₂ exceeds 800 ppm, HVAC ramps up
